...
const CalendarView = dynamic(
  ...
  { loading: () => <ViewSkeleton title="Calendario" /> }
);
const ClientList = dynamic(
  () => import('@/components/client-list'),
  { loading: () => <ViewSkeleton title="Clientes" /> }
);
const ClientProfile = dynamic(
  () => import('@/components/client-profile'),
  { loading: () => <ViewSkeleton title="Perfil del Cliente" /> }
);
const ServiceManagement = dynamic(
  () => import('@/components/service-management'),
  { loading: () => <ViewSkeleton title="Servicios" /> }
);
const AutomationPanel = dynamic(
  () => import('@/components/automation-panel'),
  { loading: () => <ViewSkeleton title="Automatizaciones" /> }
);
const SettingsPanel = dynamic(
  () => import('@/components/settings-panel'),
  { loading: () => <ViewSkeleton title="Configuración" /> }
);
const AdminView = dynamic(
  () => import('@/components/admin-view'),
  { loading: () => <ViewSkeleton title="Administración" /> }
);
